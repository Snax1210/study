...
- [过期键的删除策略](#过期键的删除策略)
  ...
  - [我们知道通过expire来设置key 的过期时间，那么对过期的数据怎么处理呢?](#我们知道通过expire来设置key-的过期时间那么对过期的数据怎么处理呢)
- [内存相关](#内存相关)
...
- [线程模型](#线程模型)
  - [Redis线程模型](#redis线程模型)
  - [什么是事务？](#什么是事务)
  - [Redis事务的概念](#redis事务的概念)
  - [Redis事务的三个阶段](#redis事务的三个阶段)
  - [Redis事务相关命令](#redis事务相关命令)
  - [事务管理（ACID）概述](#事务管理acid概述)
  - [Redis事务支持隔离性吗](#redis事务支持隔离性吗)
  - [Redis事务保证原子性吗，支持回滚吗](#redis事务保证原子性吗支持回滚吗)
  - [Redis事务其他实现](#redis事务其他实现)
- [集群方案](#集群方案)
  - [哨兵模式](#哨兵模式)
  - [官方Redis Cluster 方案(服务端路由查询)](#官方redis-cluster-方案服务端路由查询)
  - [基于客户端分配](#基于客户端分配)
  - [基于代理服务器分片](#基于代理服务器分片)
  - [Redis 主从架构](#redis-主从架构)
  - [Redis集群的主从复制模型是怎样的？](#redis集群的主从复制模型是怎样的)
  - [生产环境中的 redis 是怎么部署的？](#生产环境中的-redis-是怎么部署的)
...
- [缓存异常](#缓存异常)
  ...
  - [缓存热点key](#缓存热点key)
- [常用工具](#常用工具)
  - [Redis支持的Java客户端都有哪些？官方推荐用哪个？](#redis支持的java客户端都有哪些官方推荐用哪个)
  - [Redis和Redisson有什么关系？](#redis和redisson有什么关系)
  - [Jedis与Redisson对比有什么优缺点？](#jedis与redisson对比有什么优缺点)
- [其他问题](#其他问题)
