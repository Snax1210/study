...
# Spring cloud
- [为什么需要学习Spring Cloud](#为什么需要学习spring-cloud)
- [什么是Spring Cloud](#什么是spring-cloud)
- [设计目标与优缺点](#设计目标与优缺点)
  - [设计目标](#设计目标)
  - [优缺点](#优缺点)
- [Spring Cloud发展前景](#spring-cloud发展前景)
- [整体架构](#整体架构)
- [主要项目](#主要项目)
...
- [Spring Cloud的版本关系](#spring-cloud的版本关系)
  - [Spring Cloud和SpringBoot版本对应关系](#spring-cloud和springboot版本对应关系)
  - [Spring Cloud和各子项目版本对应关系](#spring-cloud和各子项目版本对应关系)
- [SpringBoot和SpringCloud的区别？](#springboot和springcloud的区别)
- [使用 Spring Boot 开发分布式微服务时，我们面临以下问题](#使用-spring-boot-开发分布式微服务时我们面临以下问题)
- [服务注册和发现是什么意思？Spring Cloud 如何实现？](#服务注册和发现是什么意思spring-cloud-如何实现)
- [Spring Cloud 和dubbo区别?](#spring-cloud-和dubbo区别)
- [负载平衡的意义什么？](#负载平衡的意义什么)
- [什么是 Hystrix？它如何实现容错？](#什么是-hystrix它如何实现容错)
- [什么是 Hystrix 断路器？我们需要它吗？](#什么是-hystrix-断路器我们需要它吗)
- [什么是 Netflix Feign？它的优点是什么？](#什么是-netflix-feign它的优点是什么)
- [什么是 Spring Cloud Bus？我们需要它吗？](#什么是-spring-cloud-bus我们需要它吗)
- [Spring Cloud断路器的作用](#spring-cloud断路器的作用)
