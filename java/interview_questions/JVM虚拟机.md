...
# JVM虚拟机
- [Java内存区域](#java内存区域)
  - [说一下 JVM 的主要组成部分及其作用？](#说一下-jvm-的主要组成部分及其作用)
  - [说一下 JVM 运行时数据区](#说一下-jvm-运行时数据区)
  - [深拷贝和浅拷贝](#深拷贝和浅拷贝)
  - [说一下堆栈的区别？](#说一下堆栈的区别)
  - [队列和栈是什么？有什么区别？](#队列和栈是什么有什么区别)
...
- [垃圾收集器](#垃圾收集器)
  ...
  - [GC是什么？为什么要GC](#gc是什么为什么要gc)
  - [垃圾回收的优点和原理。并考虑2种回收机制](#垃圾回收的优点和原理并考虑2种回收机制)
  ...
  - [在Java中，对象什么时候可以被垃圾回收](#在java中对象什么时候可以被垃圾回收)
  - [JVM中的永久代中会发生垃圾回收吗](#jvm中的永久代中会发生垃圾回收吗)
  ...
  - [新生代垃圾回收器和老年代垃圾回收器都有哪些？有什么区别？](#新生代垃圾回收器和老年代垃圾回收器都有哪些有什么区别)
  - [简述分代垃圾回收器是怎么工作的？](#简述分代垃圾回收器是怎么工作的)
- [内存分配策略](#内存分配策略)
  - [简述java内存分配与回收策率以及Minor GC和Major GC](#简述java内存分配与回收策率以及minor-gc和major-gc)
